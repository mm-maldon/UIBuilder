...
class ChildGenome():
    def __init__(self):
        ...
        self.max_asset_val = 1  # The max value for the heirarchy of assets
        self.min_asset_val = 0 # The max value for the heirarchy of assets
    ...
    def load_traits(self):
        ...
        new_len = len(self.assets)
        curr_ind = len(self.assets)

        for entry in self.assets.keys():
            self.assets[entry] = curr_ind / new_len
            curr_ind -= 1